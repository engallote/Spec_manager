...
public class LanguageModify extends AppCompatActivity{
...
//                    t_day2 = day2.getText().toString();
                        ...
                        && t_score.length() > 0 && t_number.length() > 0 && t_agency.length() > 0)
                {
                    ...
                    sdb.execSQL("UPDATE lanDB SET name='"+t_name+"', year1='"+t_year1+"', month1='"+t_month1+"',day1='"+t_day1+"',year2='"+t_year2+"',month2='" + t_month2 +"',day2='" + t_day2
                            + "',score='" + t_score + "',number= '" + t_number + "', number2='" + t_number2 + "',agency= '" + t_agency + "', chk='" + chk + "' WHERE id=" + ID + ";");
